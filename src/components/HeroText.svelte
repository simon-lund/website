...
<div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center max-w-5xl mx-auto">
	...
	<div bind:this={contentEl}>
		<p
			class="text-2xl sm:text-3xl font-bold leading-snug text-ink mb-6"
			style="font-family: var(--font-heading);"
		>
			Reimagining software with intelligence at its heart.
		</p>
		<p class="text-lg text-ink-light leading-relaxed mb-2">
